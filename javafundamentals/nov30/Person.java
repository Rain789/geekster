public class Person {
    ...
    Person(){
        this.Name="Rain Mohammad Naushad";
        this.Email="rainnoushad@gmail.com";
        this.age=22;
    ...
    public int getNumber(){return this.phonenumber;}
    ...
    public static void main(String[] args){
        ...
        p2.setName("Rain Mohammad Naushad");
        p2.setEmail("rainnoushad@gamil.com");
        p2.setAge(22);
